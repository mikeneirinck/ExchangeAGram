...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func createUIAlertController(indexPath: NSIndexPath) {
        ...
        let photoAction = UIAlertAction(title: "Post photo to Facebook with caption", style: UIAlertActionStyle.Destructive) { (UIAlertActionStyle) -> Void in
    ...
    func filteredImageFromImage (data: NSData, filter: CIFilter) -> UIImage {
        let unfilteredImage: CIImage = CIImage(data: data)
